...
23. [最长有效括号](/basical/string/code/longestvalidparathesis.md)  
...
85. [判断通过操作能否让字符串相等II](/basical/string/code/checkstrings.md)
86. [统计一个字符串k子序列美丽值最大值](/basical/string/code/countsubsequencewithmaxbeauty.md)
87. [子字符串异或查询](/basical/string/code/substringforqueries.md)
### array  
...
4.   [数组中重复的元素](/basical/array/code/thesameelementinarray.md)  
...
16.  [三数之和](/basical/array/code/threesum.md) ~~review~~  :exclamation:
17.  [四数之和](/basical/array/code/foursum.md)  
18.  [寻找两个正序数组的中位数](/basical/array/code/getkthelement.md)   :exclamation:
...
99.  [限制条件下元素之间的最小绝对差](/basical/array/code/minabsolutedifference.md)
...
109. [统计距离为k的点对](/basical/array/code/countpairs.md)
...
114. [无限数组的最短子数组](/basical/array/code/minsizesubarray.md)
...
23. [收集树中的金币](/basical/gragh/code/collectthecoins.md)
24. [统计树中的合法路径数目](/basical/gragh/code/countpath.md)
25. [可以被k整除的连通块的最大数目](/basical/gragh/code/maxdivisiblecomponents.md)
26. [有向图访问计数](/basical/gragh/code/countvisitednodes.md)
...
35. [负二进制转换](/basical/IQ/code/baseneg2.md) 
...
58. [只出现一次的数字III](/basical/IQ/code/singlenumber.md)
...
8.  [按分隔符拆分字符串](/basical/simulation/code/splitwordsbyseparator.md)
...
28. [子数组的最小值之和](/basicaldatastructure/stackandquere/code/sumsubarraymins.md)
...
25. [翻倍以链表形式表示的数字](/basicaldatastructure/linkedlist/code/douleit.md)
### setandmap
...
78.  [网格中的最短路径](/algorithmn/dynamic_programming/code/shortestpath.md)
...
91.  [判断是否能拆分数组](/algorithmn/dynamic_programming/code/cansplitarray.md)
92.  [使数组和小于等于x的最少时间](/algorithmn/dynamic_programming/code/minimumtimeII.md)
93.  [统计范围内的步进数字数目](/algorithmn/dynamic_programming/code/countsteppingnumbers.md)
94.  [打家劫舍IV](/algorithmn/dynamic_programming/code/mincapability.md)
...
99.  [得到k个半回文串的最少修改次数](/algorithmn/dynamic_programming/code/minimumchanges.md)
...
108. [找到最大非递减数组的长度](/algorithmn/dynamic_programming/code/findmaximumlength.md)
### traceback
...
32. [不同路径III](/algorithmn/tracebak/code/uniquepathIII.md)
### greed
...
29. [合法分组的最少组数](/algorithmn/greed/code/mingroupsforvalidassignment.md)
### match
